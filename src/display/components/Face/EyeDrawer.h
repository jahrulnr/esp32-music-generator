  ...
  public:
    static void Draw(U8G2_SSD1306_128X64_NONAME_F_HW_I2C *_u8g2, int16_t centerX, int16_t centerY, EyeConfig *config) {
      ...
      if(config->Slope_Bottom > 0) {
        EyeDrawer::FillRectangularTriangle(_u8g2, BRc_x+config->Radius_Bottom, BRc_y+config->Radius_Bottom, BLc_x-config->Radius_Bottom, BLc_y+config->Radius_Bottom, 0);
        EyeDrawer::FillRectangularTriangle(_u8g2, BLc_x-config->Radius_Bottom, BLc_y+config->Radius_Bottom, BRc_x+config->Radius_Bottom, BRc_y+config->Radius_Bottom, 1);
      }
      else if (config->Slope_Bottom < 0) {
        EyeDrawer::FillRectangularTriangle(_u8g2, BLc_x-config->Radius_Bottom, BLc_y+config->Radius_Bottom, BRc_x+config->Radius_Bottom, BRc_y+config->Radius_Bottom, 0);
      ...
      if(config->Radius_Bottom > 0) {
        EyeDrawer::FillEllipseCorner(_u8g2, B_L, BLc_x, BLc_y, config->Radius_Bottom, config->Radius_Bottom, 1);
        EyeDrawer::FillEllipseCorner(_u8g2, B_R, BRc_x, BRc_y, config->Radius_Bottom, config->Radius_Bottom, 1);
      }
    }
